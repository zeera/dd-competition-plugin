...
class CompetitionProcess extends AdminHelper
{
    ...
    public static function drawDateTimeShow()
    {
        ...
        $maxEntries =  $productData->get_meta('_maximum_ticket', true);
            ...
            <div class="range-quantity">
                ...
                <div class="range-wrap">
                    <input
                        ...
                        step="1"
                        min="1"
                        max="<?php echo $productData->get_meta('_maximum_ticket_per_user', true) ? $productData->get_meta('_maximum_ticket_per_user', true) : get_option('maximum_ticket_default_per_user'); ?>"
                        value="<?= $productData->get_meta('_default_basket', true) ? $productData->get_meta('_default_basket', true) : get_option('default_basket_quantity'); ?>"
                        name="quantity"
